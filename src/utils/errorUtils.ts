...
export const handleServerAppError = <D>(data: ResponsTodolistsType<D>, dispatch: ThunkDispatch<unknown, unknown, AnyAction>) => {
...
export const handleServerNetworkError = <D>(error: {
    message: string
